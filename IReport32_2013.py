...
def write_component_density(doc):
    ...
    objShape = doc.Shapes.AddChart2(Type = 58).Chart
    ...
    objShape.FullSeriesCollection(1).Format.Fill.Visible = True
    objShape.FullSeriesCollection(1).Format.Fill.ForeColor.RGB = -16777024
    objShape.FullSeriesCollection(1).Format.Fill.Transparency = 0
    objShape.FullSeriesCollection(1).Format.Fill.Solid

    objShape.FullSeriesCollection(2).Format.Fill.Visible = True
    objShape.FullSeriesCollection(2).Format.Fill.ForeColor.RGB = -16727809
    objShape.FullSeriesCollection(2).Format.Fill.Transparency = 0
    objShape.FullSeriesCollection(2).Format.Fill.Solid

    objShape.FullSeriesCollection(3).Format.Fill.Visible = True
    objShape.FullSeriesCollection(3).Format.Fill.ForeColor.RGB = -2894893
    objShape.FullSeriesCollection(3).Format.Fill.Transparency = 0
    objShape.FullSeriesCollection(3).Format.Fill.Solid
...
def write_level_chart(doc, level, data):
    ...
    if(len(data) == 0):
        ...
        return       
    LevelChart = doc.Shapes.AddChart2(Type=57).Chart
...
##    print sortHighList
    ...
    LevelChart.FullSeriesCollection(1).Format.Fill.Visible = True
    LevelChart.FullSeriesCollection(1).Format.Fill.ForeColor.RGB = color
    LevelChart.FullSeriesCollection(1).Format.Fill.Transparency = 0
    LevelChart.FullSeriesCollection(1).Format.Fill.Solid
...
def write_defect_level_chart(doc):
    defectLevelChart = doc.Shapes.AddChart2().Chart
    ...
    #High Impact 修改为红色
    defectLevelChart.FullSeriesCollection(1).Points(1).Format.Fill.Visible = True
    defectLevelChart.FullSeriesCollection(1).Points(1).Format.Fill.ForeColor.RGB = -16777024
    defectLevelChart.FullSeriesCollection(1).Points(1).Format.Fill.Transparency = 0
    defectLevelChart.FullSeriesCollection(1).Points(1).Format.Fill.Solid

    #Medium Impact 修改为黄色
    defectLevelChart.FullSeriesCollection(1).Points(2).Format.Fill.Visible = True
    defectLevelChart.FullSeriesCollection(1).Points(2).Format.Fill.ForeColor.RGB = -16727809
    defectLevelChart.FullSeriesCollection(1).Points(2).Format.Fill.Transparency = 0
    defectLevelChart.FullSeriesCollection(1).Points(2).Format.Fill.Solid
